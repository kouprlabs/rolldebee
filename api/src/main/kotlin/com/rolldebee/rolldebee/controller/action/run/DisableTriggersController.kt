...
@RestController
@RequestMapping("actions/run/disable_triggers")
class DisableTriggersController(
    val introspectionBuilderFactory: IntrospectionBuilderFactory,
    var triggerDisablerFactory: TriggerDisablerFactory,
    ...
    fun run(@Valid @RequestBody body: DisableTriggersOptions): Action {
        ...
        GlobalScope.launch {
            try {
                ...
                val switchSummary = triggerDisablerFactory.get(connection).run(connection)
